    ...
    return {
      ...
      ui: {
        ...
        zh: {
          ...
          aboutParagraphs: [
            'Wow Games 是一家位于美国明尼苏达州的单人手机游戏开发工作室，专注于简单、好玩、耐回味的休闲与逻辑益智游戏。自 2022 年起，我们与 Voodoo 合作进行超休闲游戏原型开发，目前已实现自主发行。',
            '工作室由 Peter Long 独立运营。他是一名拥有十余年中西方手游行业经验的游戏设计师，曾参与开发一款下载量超过 5 亿的益智游戏。这里的每一款游戏，从设计、开发到发行，都由他一人完成——依托一套 AI 辅助的制作流程，让单人工作室拥有小团队的产出速度。',
            '我们相信，用心打磨、持续推出的小游戏，依然值得在你的手机上占有一席之地。'
          ],
          footerEmail: '邮箱',
          footerPrivacy: '隐私政策'
        }
